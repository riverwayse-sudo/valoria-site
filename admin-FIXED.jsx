...
export default function AdminPage() {
  ...
  // Employers/organisers live in `profiles`, a completely separate table
  // from professional_profiles. The stat card below used to filter
  // professional_profiles for active_tracks.includes('facilitator') and
  // call that "Employers" — it was counting the wrong people from the
  // wrong table. Total Accounts also only ever summed professional_profiles,
  // silently excluding every buyer account from the total.
  ...
  const totalAccounts = profiles.length + buyerProfiles.length
