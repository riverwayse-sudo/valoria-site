-- Add canonical career title to the public marketplace projection.
-- The existing projection is recreated because PostgreSQL view columns cannot
-- be inserted in the middle of an existing view definition.
