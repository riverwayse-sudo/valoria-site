...
-- Public discovery is driven by active capability governance, not profile-level
-- listing fields. One professional remains one public row with all listed capabilities.
