  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch(endpoint, {
        ...
        body: JSON.stringify({
          full_name: name.trim(), email: email.trim().toLowerCase(), phone: phone.trim() || null,
          role: role.trim() || null, interest: interest || null, type: eventMode ? 'event' : 'gate', source,
        }),
      })
