...
export default function WaitlistModal({ open, onClose, source = 'site_gate' }) {
  ...
  return (
    <>
      ...
      <div className="vi-gate-overlay" role="dialog" aria-modal="true" aria-label="Join the Valoria waitlist" onClick={() => onClose && onClose()}>
        <div className="vi-gate-card" onClick={e => e.stopPropagation()}>

          {onClose && (
            <button className="vi-gate-close" onClick={onClose} aria-label="Close">×</button>
          )}
          ...
          {status === 'done' ? (
              ...
              <div style={{ borderTop: '1px solid rgba(201,168,76,0.15)', marginTop: '24px', paddingTop: '24px' }}>
                ...
                <div style={{ marginBottom: '28px' }}>
                  ...
                  <p style={{ fontSize: '13px', color: 'rgba(247,244,238,0.55)', lineHeight: 1.8, fontFamily: 'var(--font)', fontWeight: 300, margin: 0 }}>
                    Every day, exceptional African professionals get passed over. Not because they lack capability, but because no one can prove it. The same names circulate. The same networks win. Everyone else waits.
                  </p>
                </div>
                ...
                <div style={{ marginBottom: '28px' }}>
                  ...
                  <p style={{ fontSize: '13px', color: 'rgba(247,244,238,0.55)', lineHeight: 1.8, fontFamily: 'var(--font)', fontWeight: 300, margin: 0 }}>
                    Valoria changes the question employers and organisers ask. Instead of <em style={{ color: '#F7F4EE', fontStyle: 'italic' }}>who do I already know</em>, it becomes <em style={{ color: '#C9A84C', fontStyle: 'italic' }}>who is genuinely the best for this</em>. One assessed standard. No guesswork. No gatekeeping.
                  </p>
                </div>
                ...
                <div style={{ marginBottom: '28px' }}>
                  ...
                  <p style={{ fontSize: '13px', color: 'rgba(247,244,238,0.55)', lineHeight: 1.8, fontFamily: 'var(--font)', fontWeight: 300, margin: 0 }}>
                    A marketplace where every profile is verified by the VALU Index. Employers search by capability, not connection. Speakers get booked on merit. Facilitators earn trust before they walk into the room.
                  </p>
                </div>
            ...
            <>
              ...
              <p className="vi-gate-sub">
                We&apos;re building the marketplace for assessed African professionals. Join the list and we&apos;ll reach out the moment it&apos;s ready for you.
              </p>
