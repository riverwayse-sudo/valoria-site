  ...
  return (
    <>
      <style>{`
        ...
        .vi-gate-card{background:#0F0F1A;border:1px solid rgba(201,168,76,.22);border-radius:16px;padding:clamp(30px,5vw,48px);max-width:540px;width:100%;position:relative;animation:gateUp .4s ease;max-height:90vh;overflow-y:auto}
        ...
        .vi-gate-stripe{height:3px;border-radius:2px;overflow:hidden;margin-bottom:24px;background:#C9A84C}
        .vi-gate-eyebrow{font-size:9px;font-weight:700;letter-spacing:.2em;color:rgba(201,168,76,.72);text-transform:uppercase;margin-bottom:12px;font-family:var(--font)}
        .vi-gate-title{font-family:var(--font);font-size:clamp(25px,4vw,38px);font-weight:300;line-height:1.08;letter-spacing:-.025em;color:#F7F4EE;margin:0 0 13px}
        .vi-gate-title em{color:#C9A84C;font-style:italic;font-weight:300}
        .vi-gate-sub{font-size:13px;font-weight:300;color:rgba(247,244,238,.55);line-height:1.7;margin:0 0 24px}
        .vi-event-meta{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:0 0 24px;padding:14px;border:1px solid rgba(201,168,76,.14);background:rgba(247,244,238,.025);border-radius:8px}
        .vi-event-meta-item{min-width:0}.vi-event-meta-label{font-size:8px;font-weight:700;letter-spacing:.18em;color:rgba(201,168,76,.55);text-transform:uppercase;margin-bottom:5px}.vi-event-meta-value{font-size:12px;color:#F7F4EE;line-height:1.45}
        .vi-event-note{font-size:11px;color:rgba(247,244,238,.38);line-height:1.6;margin:-10px 0 22px}
        .vi-gate-field{margin-bottom:13px}.vi-gate-label{display:block;font-size:9px;font-weight:700;color:rgba(201,168,76,.5);letter-spacing:.18em;text-transform:uppercase;margin-bottom:7px;font-family:var(--font)}
        .vi-gate-input,.vi-gate-select{width:100%;background:rgba(255,255,255,.04);border:1px solid rgba(247,244,238,.1);border-radius:6px;padding:12px 14px;color:#F7F4EE;font-size:13px;font-family:var(--font);box-sizing:border-box}
        .vi-gate-input::placeholder{color:rgba(247,244,238,.22)}.vi-gate-input:focus,.vi-gate-select:focus{outline:none;border-color:rgba(201,168,76,.5);box-shadow:0 0 0 3px rgba(201,168,76,.07)}
        .vi-gate-select{color:rgba(247,244,238,.6)}.vi-gate-select option{background:#0F0F1A;color:#F7F4EE}.vi-gate-row{display:grid;grid-template-columns:1fr 1fr;gap:12px}
        .vi-gate-error{font-size:12px;color:#D85A30;margin-bottom:12px;padding:10px 12px;background:rgba(216,90,48,.07);border-left:2px solid rgba(216,90,48,.5)}
        .vi-gate-btn{width:100%;padding:15px 24px;background:#C9A84C;color:#0F0F1A;font-size:11px;font-weight:700;letter-spacing:.14em;border:0;border-radius:9999px;cursor:pointer;font-family:var(--font);margin-top:5px}.vi-gate-btn:hover{opacity:.88}.vi-gate-btn:disabled{opacity:.5;cursor:not-allowed}
        .vi-gate-done{text-align:center;padding:10px 0}.vi-gate-done-icon{width:56px;height:56px;border-radius:50%;background:rgba(201,168,76,.1);border:1px solid rgba(201,168,76,.3);display:flex;align-items:center;justify-content:center;margin:0 auto 20px}.vi-gate-done-title{font-family:var(--font);font-size:25px;font-weight:300;color:#F7F4EE;margin-bottom:10px}.vi-gate-done-sub{font-size:13px;color:rgba(247,244,238,.48);line-height:1.7;margin:0}
        @media(max-width:480px){.vi-gate-row,.vi-event-meta{grid-template-columns:1fr}.vi-gate-card{padding:28px 22px}}
      `}</style>
        ...
        <div className="vi-gate-card" onClick={e => e.stopPropagation()}>
          ...
          {status === 'done' ? (
            <div className="vi-gate-done">
              <div className="vi-gate-done-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M5 12l5 5L20 7" stroke="#C9A84C" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></div>
              <div className="vi-gate-done-title">You&apos;re registered.</div>
              <p className="vi-gate-done-sub">Your details have been received for <strong style={{color:'#F7F4EE',fontWeight:400}}>Strategic Thinking: You Are Solving the Wrong Problems.</strong> We&apos;ll be in touch with the event details.</p>
            </div>
          ) : eventMode ? (
            <>
              ...
              <div className="vi-event-meta">
                <div className="vi-event-meta-item"><div className="vi-event-meta-label">Date</div><div className="vi-event-meta-value">Saturday, 26 September 2026</div></div>
                <div className="vi-event-meta-item"><div className="vi-event-meta-label">Time</div><div className="vi-event-meta-value">10:00–11:30 AM WAT</div></div>
                <div className="vi-event-meta-item"><div className="vi-event-meta-label">Speaker</div><div className="vi-event-meta-value">Temi Adetokunbo</div></div>
                <div className="vi-event-meta-item"><div className="vi-event-meta-label">Cluster</div><div className="vi-event-meta-value">INTELLIGENCE</div></div>
              </div>
            ...
            <>
              ...
              <p className="vi-gate-sub">We&apos;re building the marketplace for assessed African professionals. Join the list and we&apos;ll reach out when it&apos;s ready for you.</p>
              <form onSubmit={handleSubmit} noValidate>
                <div className="vi-gate-row"><div className="vi-gate-field"><label className="vi-gate-label" htmlFor="gate-name">Full Name</label><input id="gate-name" className="vi-gate-input" type="text" placeholder="Your name" value={name} onChange={e => setName(e.target.value)} required /></div><div className="vi-gate-field"><label className="vi-gate-label" htmlFor="gate-email">Email Address</label><input id="gate-email" className="vi-gate-input" type="email" placeholder="you@example.com" value={email} onChange={e => setEmail(e.target.value)} required /></div></div>
