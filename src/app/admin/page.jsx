  ...
  return (
    <main style={styles.root}>
      ...
      <header className="vi-admin-header" style={styles.header}>
        <div style={styles.brand}><Link href="/"><img src="/valoria-original.png" alt="Valoria Institute" style={{height:40,width:'auto'}} /></Link><span style={styles.divider}/><span style={styles.adminLabel}>ADMIN</span></div>
