    ...
    <main id="main-content">
      ...
      <section className="valu-section" id="valu">
        <div className="container valu-inner">
          ...
          <ValuMotion className="radar-card" aria-label="Illustrative radar chart for the VALU Index"><div className="rc-label">ILLUSTRATIVE VALU PROFILE</div><svg className="rc-radar" viewBox="0 0 260 260" aria-hidden="true"><g opacity=".35" stroke="#D4C9A8" strokeWidth=".5" fill="none"><polygon points="130,22 222,80 192,188 68,188 38,80"/><polygon points="130,50 196,98 172,174 88,174 64,98"/><polygon points="130,78 170,116 152,160 108,160 90,116"/><polygon points="130,106 144,134 132,146 128,146 116,134"/><line x1="130" y1="22" x2="130" y2="188"/><line x1="130" y1="22" x2="222" y2="80"/><line x1="130" y1="22" x2="192" y2="188"/><line x1="130" y1="22" x2="68" y2="188"/><line x1="130" y1="22" x2="38" y2="80"/></g><polygon points="130,36 214,88 186,178 74,178 46,88" fill="rgba(201,168,76,.40)" stroke="#C9A84C" strokeWidth="1.5"/><circle data-valu-point cx="130" cy="36" r="4" fill="#C9A84C"/><circle data-valu-point cx="214" cy="88" r="4" fill="#C9A84C"/><circle data-valu-point cx="186" cy="178" r="4" fill="#C9A84C"/><circle data-valu-point cx="74" cy="178" r="4" fill="#C9A84C"/><circle data-valu-point cx="46" cy="88" r="4" fill="#C9A84C"/><text x="130" y="12" textAnchor="middle" fontFamily="Raleway,sans-serif" fontSize="10" fontWeight="700" fill="#C9A84C">P</text><text x="234" y="88" textAnchor="start" fontFamily="Raleway,sans-serif" fontSize="10" fontWeight="700" fill="#C9A84C">R</text><text x="196" y="202" textAnchor="middle" fontFamily="Raleway,sans-serif" fontSize="10" fontWeight="700" fill="#C9A84C">I</text><text x="62" y="202" textAnchor="middle" fontFamily="Raleway,sans-serif" fontSize="10" fontWeight="700" fill="#C9A84C">M</text><text x="22" y="88" textAnchor="end" fontFamily="Raleway,sans-serif" fontSize="10" fontWeight="700" fill="#C9A84C">E</text></svg><div className="rc-bottom"><div><div className="rc-b-label">EXAMPLE ONLY</div><div style={{fontFamily:'var(--font)',fontSize:'40px',fontWeight:800,color:'var(--gold)',lineHeight:1}}>84</div></div><div><div className="rc-b-label">DESIGNATION</div><div className="rc-desig">ILLUSTRATIVE · NOT AN ASSESSMENT</div></div></div></ValuMotion>
        </div>
      </section>
