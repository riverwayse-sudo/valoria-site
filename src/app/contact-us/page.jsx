...
export const metadata = {
  title: 'Contact Us',
  description: 'Get in touch with Valoria Institute.',
}
      ...
      <main id="main-content">
          ...
          <div className="page-section-inner two-col">
            <Reveal>
              <div className="info-card">
                <div className="eyebrow"><div className="eyebrow-line" /><span className="eyebrow-text">EMAIL</span></div>
        ...
        <section className="page-section alt cta-banner">
          <Reveal>
            ...
            <p className="page-sub">Go straight to the team that handles it.</p>
